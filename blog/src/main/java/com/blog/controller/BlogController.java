...
public class BlogController
{
          ...
          throws Exception
  {
    ...
    mav.addObject("pageTitle", blog.getTitle() + "_My Blog");
          ...
          throws Exception
  {
    ...
    mav.addObject("pageTitle", "Search key words'" + q + "''s result_My Blog");
    mav.setViewName("mainTemp");
    return mav;
  }
  ...
  private String genUpAndDownPageCode(Blog lastBlog, Blog nextBlog, String projectContext)
  {
    ...
    if ((lastBlog == null) || (lastBlog.getId() == null)) {
      pageCode.append("<p>Previous post：No post</p>");
    } else {
      pageCode.append("<p>Previous post：<a href='" + projectContext + "/blog/articles/" + lastBlog.getId() + ".html'>" + lastBlog.getTitle() + "</a></p>");
    }
    if ((nextBlog == null) || (nextBlog.getId() == null)) {
      pageCode.append("<p>Next post：No post</p>");
    } else {
      pageCode.append("<p>Next post：<a href='" + projectContext + "/blog/articles/" + nextBlog.getId() + ".html'>" + nextBlog.getTitle() + "</a></p>");
    }
  ...
  private String genUpAndDownPageCode(Integer page, Integer totalNum, String q, Integer pageSize, String projectContext)
  {
    ...
    if (page.intValue() > 1) {
      pageCode.append("<li><a href='" + projectContext + "/blog/q.html?page=" + (page.intValue() - 1) + "&q=" + q + "'>Precious page</a></li>");
    } else {
      pageCode.append("<li class='disabled'><a href='#'>Precious page</a></li>");
    }
    if (page.intValue() < totalPage) {
      pageCode.append("<li><a href='" + projectContext + "/blog/q.html?page=" + (page.intValue() + 1) + "&q=" + q + "'>Next page</a></li>");
    } else {
