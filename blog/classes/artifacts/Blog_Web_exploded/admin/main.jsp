...
<div region="north" style="height: 78px;background-color: #E0ECFF;overflow:hidden">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img style="margin-top: -20px;" alt="logo" src="${pageContext.request.contextPath}/static/images/logo1.png">
			</td>
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 200px"><font color="#109ceb" size="10">Welcome to edit your blog~</font></div>
		</div>
	</div>
</div>
